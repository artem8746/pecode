...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const posts = yield postsService.getAll();
        res.status(StatusCode_1.StatusCode.OK);
        res.send(posts);
    }
    catch (ex) {
        res.sendStatus(StatusCode_1.StatusCode.INTERNAL_SERVER_ERROR);
    }
});
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const createdPost = yield postsService.create(post);
        res.status(StatusCode_1.StatusCode.CREATED);
